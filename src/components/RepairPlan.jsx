        ...
        <div className="flex gap-2">
          ...
          <motion.button
            ...
            onClick={() => {
              ...
              w.document.write(`<html><head><title>INFRASIGHT Repair Plan</title>
                ...
                <hr><p style="color:#888;font-size:12px">Generated by INFRASIGHT AI Infrastructure Monitoring System</p>
                </body></html>`);
              w.document.close();
              w.print();
            }}
